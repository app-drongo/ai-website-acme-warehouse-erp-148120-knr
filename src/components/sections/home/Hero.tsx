...
const DEFAULT_HERO = {
  badge: 'New: RFID Integration Available',
  title: 'Streamline your warehouse operations with',
  titleHighlight: 'Acme Warehouse ERP',
  description:
    'Complete inventory management solution with real-time barcode scanning, RFID tracking, and automated workflows. Reduce errors by 95% and increase efficiency across your entire warehouse operation.',
  features: [
  ...
  statsLabel1: 'Accuracy Rate',
  statsValue1: '99.8%',
  statsLabel2: 'Time Saved',
  statsValue2: '40 hrs/week',
} as const;
