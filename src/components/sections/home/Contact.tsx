...
const DEFAULT_CONTACT = {
  ...
  mainTitle: 'Ready to Transform Your',
  mainTitleHighlight: 'Warehouse Operations?',
  mainDescription:
    'Connect with our ERP specialists to discover how Acme Warehouse ERP can streamline your inventory management with advanced barcode and RFID technology.',
  formTitle: 'Request a Demo',
  formDescription:
    'Schedule a personalized demonstration of our warehouse management system and see how we can optimize your operations.',
  submitButton: 'Schedule Demo',
  contactSectionTitle: 'Connect With Our Team',
  method1Title: 'Sales Inquiries',
  method1Description: 'Speak with our ERP consultants',
  method1Contact: 'sales@acmewarehouseerp.com',
  method2Title: 'Technical Support',
  method2Description: '24/7 system support hotline',
  method2Contact: '+1 (800) 555-RFID',
  method3Title: 'Live Chat',
  method3Description: 'Instant support & consultation',
  method3Contact: 'Available during business hours',
  officesSectionTitle: 'Regional Offices',
  office1City: 'Chicago Hub',
  office1Address: '2500 Logistics Blvd, Suite 400',
  office1Timezone: 'CST (UTC-6)',
  office2City: 'Los Angeles',
  office2Address: '1800 Distribution Way, Floor 12',
  office2Timezone: 'PST (UTC-8)',
  office3City: 'Atlanta',
  office3Address: '3200 Supply Chain Drive, Building C',
  office3Timezone: 'EST (UTC-5)',
  hoursTitle: 'Support Hours',
  hoursWeekdayLabel: 'Monday - Friday',
  hoursWeekdayTime: '7:00 AM - 8:00 PM',
  ...
  supportNote: 'Priority support & dedicated account manager for Enterprise clients',
  nameLabel: 'Full Name *',
  namePlaceholder: 'John Smith',
  emailLabel: 'Business Email *',
  emailPlaceholder: 'john@yourcompany.com',
  companyLabel: 'Company Name *',
  companyPlaceholder: 'Your Warehouse/Distribution Center',
  messageLabel: 'Tell us about your warehouse needs *',
  messagePlaceholder:
    'Describe your current inventory challenges, warehouse size, and integration requirements...',
} as const;
