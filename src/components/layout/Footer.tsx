...
const DEFAULT_FOOTER = {
  logoText: 'Acme Warehouse ERP',
  companyDescription:
    'Streamline your warehouse operations with our comprehensive ERP solution. Trusted by over 2,000 logistics companies worldwide for inventory management, order fulfillment, and supply chain optimization.',
  contactEmail: 'support@acmewarehouseerp.com',
  contactPhone: '+1 (800) 555-ACME',
  contactAddress: '1250 Industrial Blvd, Suite 400, Atlanta, GA 30309',
  newsletterTitle: 'ERP Updates & Insights',
  newsletterPlaceholder: 'Enter your business email',
  newsletterDisclaimer:
    'Get warehouse management tips, product updates, and industry insights. Unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Support',
  section4Title: 'Legal',
  copyrightText: '© 2024 Acme Warehouse ERP. All rights reserved.',
  madeWithText: 'by warehouse experts',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/acmewarehouseerp',
  social2Href: 'https://facebook.com/acmewarehouseerp',
  social3Href: 'https://instagram.com/acmewarehouseerp',
  social4Href: 'https://linkedin.com/company/acme-warehouse-erp',
  social5Href: 'https://github.com/acme-warehouse-erp',
} as const;
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        },
        {
          ...
          href: '/features/fulfillment',
          editableId: 'link-footer-fulfillment',
        },
        {
          name: 'Warehouse Analytics',
          href: '/features/analytics',
          editableId: 'link-footer-analytics',
        },
        { name: 'Barcode Scanning', href: '/features/barcode', editableId: 'link-footer-barcode' },
        { name: 'API Integration', href: '/api', editableId: 'link-footer-api' },
        { name: 'Mobile App', href: '/mobile', editableId: 'link-footer-mobile' },
      ],
    },
    {
      title: config.section2Title,
      links: [
        { name: 'About Acme', href: '/about', editableId: 'link-footer-about' },
        { name: 'Customer Stories', href: '/case-studies', editableId: 'link-footer-stories' },
        { name: 'Careers', href: '/careers', editableId: 'link-footer-careers' },
        { name: 'Press & Media', href: '/press', editableId: 'link-footer-press' },
    ...
    },
    {
      ...
      links: [
        { name: 'Help Center', href: '/help', editableId: 'link-footer-help' },
        {
          name: 'Implementation',
          href: '/implementation',
          editableId: 'link-footer-implementation',
        },
        { name: 'Training Videos', href: '/training', editableId: 'link-footer-training' },
        { name: 'Webinars', href: '/webinars', editableId: 'link-footer-webinars' },
        { name: 'System Status', href: '/status', editableId: 'link-footer-status' },
        { name: 'Technical Support', href: '/support', editableId: 'link-footer-tech-support' },
      ],
    },
    {
      ...
      links: [
        ...
        { name: 'SOC 2 Certification', href: '/soc2', editableId: 'link-footer-soc2' },
